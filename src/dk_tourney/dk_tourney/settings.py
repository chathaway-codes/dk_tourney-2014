# Django settings for dk_tourney project.
import os
...
SECRET_KEY = 'fy&amp;h_deng@cc=s670zuwf^ds#od0wa4d1p+rq29%o&amp;p1p-tlt%'
...
ROOT_URLCONF = 'dk_tourney.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'dk_tourney.wsgi.application'
