...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.lead'
        db.add_column('tournament_team', 'lead',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='team_lead_set', to=orm['tournament.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.lead'
        db.delete_column('tournament_team', 'lead_id')
    ...
    models = {
        ...
        'tournament.team': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lead': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'team_lead_set'", 'to': "orm['tournament.Player']"}),
