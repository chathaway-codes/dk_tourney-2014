...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('tournament_player_perms')

        # Deleting model 'Computer_Perms'
        db.delete_table('tournament_computer_perms')


    def backwards(self, orm):
        # Adding model 'Player_Perms'
        db.create_table('tournament_player_perms', (
        ...
        db.create_table('tournament_computer_perms', (
